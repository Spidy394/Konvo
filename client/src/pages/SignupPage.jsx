...
export const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <User2 className="size-5 text-base-content/40 z-10" />
                </div>
                <input
                  type="text"
                  className={`input input-bordered w-full pl-10`}
                  placeholder="Byomkesh this... and you are?"
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className={`input input-bordered w-full pl-10`}
                  placeholder="Where do I send the case file?"
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className={`input input-bordered w-full pl-10`}
                  placeholder="Satyanweshi66 is already taken"
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input input-bordered w-full pl-10`}
                  placeholder="Your private key to the case files"
          ...
          <div className="text-center">
            <p className="text-base-content/60">
              Back from your last case?{" "} 
              <Link to="/login" className="link link-primary z-10">
                Sign in
              </Link>{" "}here.
            </p>
          </div>
      ...
      {/* right-side */}
      <AuthImagePattern 
        title="Enter the adda 🍵"
        subtitle="Uncover stories, follow clues, and connect with fellow sleuths of life. ❣️"
      />
